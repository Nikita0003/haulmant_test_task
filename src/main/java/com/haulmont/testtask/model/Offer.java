...
public class Offer {
    ...
    public Offer(long id, Client client, Credit credit, double totalSum, LocalDate dateOffer, int countPayment,
    ...
    public void setTotalSum(double totalSum) {
        if (totalSum <= this.credit.getLimit())
            this.totalSum = totalSum;
    }
    ...
    private void setCountPayment(int countPayment) {
        this.countPayment = countPayment;
    }
